...
**Topic 03 of 9** · **AT1 content Topic** — the slides and the AT1 workbook advance together: each component ends in the workbook task it prepares.
...
- **C1 — Requirements, and the current recovery position.** Culminates in the workbook: **tasks 20, 21 and 22**.
- **C2 — Recovery objectives, and the data you protect.** Culminates in the workbook: **tasks 23 and 24**.
- **C3 — Risks, exclusions and impact.** Culminates in the workbook: **tasks 25, 26 and 27**.
