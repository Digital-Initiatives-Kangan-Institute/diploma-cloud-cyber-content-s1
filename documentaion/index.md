...
A map of what lives in this workspace and what state each piece of source material is in.

## Top-level workspace files

| File | Purpose |
|---|---|
| `clusters.md` | The proposed cluster structure. |
| `project_overview.md` | High-level overview of the project — context, scope, constraints, success criteria. |
| `work_breakdown_structure.md` | Phased plan of what needs to happen, with critical-path items flagged. |
| `index.md` | This file. |
