...
The student-facing version of AT1 (Design), derived from the assessor instrument
...
criteria (what they're marked against), and the detailed task instructions for the Solution Design
and the design presentation. The assessor-only material — the marking benchmark and its UoC
traceability — is NOT included.

Usage:  python scripts/s1_cl3/build_s1_cl3_at1_student.py [output.docx]
Default: S1-CL3-Cloud-Infrastructure-Improvement/assessments/AT1/AT1-Design-Student.docx
"""
import sys
