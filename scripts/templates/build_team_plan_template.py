...
def build(path):
    ...
    for k, v in cover_rows:
        ...
        vr.italic = True; vr.font.color.rgb = RGBColor.from_string(GREY)
    ...
    add_guidance_text(doc, "State the engagement, your team's common objective, the responsibilities (who "
    ...
    add_guidance_text(doc, "Identify the contingencies most likely to impact your team — for example unplanned "
    ...
    add_template_table(doc, ["Contingency", "Likelihood", "Plan"],
             [["[ Contingency ]", "[ H/M/L ]", "[ … ]"]] * 4,
             widths=[5.0, 2.3, 8.2])

    h1("7. Team operating norms")
    add_guidance_text(doc, "How will the team actually work — the meeting cadence (rotating chair), how "
    ...
    add_guidance_text(doc, "Answer the Knowledge Evidence questions from your assessment task here, in your "
    ...
    add_template_table(doc, ["Question", "Response"],
