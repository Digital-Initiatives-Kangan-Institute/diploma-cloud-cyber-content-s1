...
sys.path.insert(0, str(next(d for d in Path(__file__).resolve().parents if (d / "helpers" / "__init__.py").exists())))
...
from helpers.yat_brand import ADDRESS, CREAM, GREY, TEAL, TERRACOTTA, WHITE  # noqa: E402
