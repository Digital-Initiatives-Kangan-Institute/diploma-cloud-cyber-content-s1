"""Teacher speaker notes for Topic 13 — HA implementation & simulation (S1-CL1).

One entry per teaching/activity/demo slide. Keys are the EXACT slide title strings
from build_s1_cl1_topic13_deck.py so they match at build time. Read only by the
...
NOTES = {
    ...
    "Demonstrate connectivity at all tiers": """
    ...
    "Compare findings to the design": """
    ...
    "Improve availability if needed": """
