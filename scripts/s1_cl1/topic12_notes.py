"""Teacher speaker notes for Topic 12 — HA design (S1-CL1).

One entry per teaching/activity slide. Keys are the EXACT slide title strings from
build_s1_cl1_topic12_deck.py so they match at build time. Read only by the teacher
...
NOTES = {
    ...
    "Estimate the recovery objectives": """
    ...
    "Review the Accounting baseline": """
    ...
    "Design redundancy — remove the SPoFs": """
    ...
    "Re-estimate the recovery objectives": """
    ...
    "Design the HA-equivalent for Accounting": """
    ...
    "Plan the implementation & simulation": """
    ...
    "Produce your HA design document": """
