"""Teacher speaker notes for Topic 08a — The workload tier: compute & elasticity (S1-CL1).

One entry per teaching/demo/activity slide. Keys are the EXACT slide title strings from
build_s1_cl1_topic08a_deck.py so they match at build time. Read only by the teacher
...
NOTES = {
    ...
    "What a server is — and a virtual one": """
    ...
    "Storage on the instance — EBS (block)": """
    ...
    "Behind the ALB + ASG — then test scaling": """
